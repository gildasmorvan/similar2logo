...
The main class of this simulation model is defined in the 'AntSimulationMain.java' file, located in the 'examples/ants/src/java/fr/lgi2a/similar2logo/examples/ants' directory of the distribution.
